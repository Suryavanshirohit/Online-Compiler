...
function loginForm() {
   ...
   ';  echo "<body style='background-color:#F98871'>";
}
...
<div id="wrapper">
	...
	<h1>Live Chat!</h1><hr/>
		...
		<p class="logout"><a id="exit" href="#" style="color:red" class="btn btn-default">Exit Live Chat</a></p>
...
<form name="message" action="">
	...
	<input name="submitmsg" class="btn btn-default" type="submit" id="submitmsg" style="color:Green" value="Send" />
</form>
</div>
...
$(document).ready(function(){
    $("#exit").click(function(){
        ...
        if(exit==true){window.location = 'livechat.php?logout=true';}     
    });
});
